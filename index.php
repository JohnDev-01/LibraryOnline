...
<html lang="en">
  <head>
    ...
    <title>Personal - Libreria Theme</title>
    <!-- Favicon-->
              ...
              <div class="text-center text-xxl-start">
                ...
                >
                  <div class="text-uppercase">
                    Tú &middot; Librería &middot; Favorita
                  </div>
                </div>
                ...
                <h1 class="display-3 fw-bolder mb-5">
                  <span class="text-gradient d-inline">Solamente aqui</span>
                </h1>
                <div
          ...
          <div class="row gx-5 justify-content-center">
            <div class="col-xxl-8">
              <div class="text-center my-5">
                ...
                <p class="text-muted">
                  Somos una libreria digital, que nos dedicamos a complacer a
                  lectores como tu, nuestro proposito es brindarte la mejor
                  experiencia que puedas encontrar en todo el mercado contamos
                  con libros unicos que te transportaran al lugar de los hechos.
                  Vive la experiencia!
                </p>
